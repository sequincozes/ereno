...
<head>
    ...
    <title>ERENO-UI - Download Datasets</title>
    ...
    <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="en/download-datasets.jsp">
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Fazer downloads de datasets</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="sv-samples" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <%= DatasetWritter.listFiles(new File(application.getRealPath("/downloads"))) %>
                                </div>
                            </div>
                        </form>
