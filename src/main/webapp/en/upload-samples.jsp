    ...
    <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="../upload-samples.jsp">
            ...
            <ul id="forms-nav" class="nav-content expand " data-bs-parent="#sidebar-nav">
                <li>
                    ...
                    <a href="upload-samples.jsp">
                        <i class="bi bi-circle"></i><span style="color: #06c !important">SV Data Upload</span>
                    </a>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" active><a style="color: #06c"> SV Data Upload </a></li>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Upload Current and Voltage Samples</h5>
                                ...
                                <div class="col-md-12">
                                    <div class="col-sm-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="sv"
                                                   onclick="generateSv();">
                                            <label class="form-check-label" for="sv">Generate SV Messages</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12" id="div-checkbox-upload" style="display: none">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="custom" name="custom"
                                                   onclick="uploadSv();">
                                            <label class="form-check-label" for="custom">Upload a custom file (otherwise, use the default file)</label>
                                        </div>
                                        <br>
                                    </div>
                                    ...
                                    <div class="col-md-12" id="div-upload" style="display: none">
                                        <div class="form-floating mb-3" style="line-height: 0.5">
                                            <input type="file" text="te" class="form-control" id="samples"
                                                   name="multiPartServlet"
                                                   style="min-height: 40px">
                                            <label for="samples">Voltage and Current Samples</label>
                                        </div>
                                    </div>
