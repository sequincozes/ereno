            ...
            <ul id="forms-nav" class="nav-content expand " data-bs-parent="#sidebar-nav">
                <li>
                    ...
                    <a href="goose-message.jsp">
                        <i class="bi bi-circle"></i><span style="color: #06c !important">Message Flow</span>
                    </a>
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Message Flow Setup</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">IED Settings</li>
                <li class="breadcrumb-item" active><a style="color: #06c"> Message Flow </a></li>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">GOOSE Message</h5>
